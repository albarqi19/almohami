...
// تقريرُ القضية — بدائيّاتُ `crm-*` وحدَها (مودالُ البناء وشاشةُ القوالب)، بلا إعادةِ
// تعريفِ أيّ صنفٍ قائم، فلا تتعلّق بترتيب الحقن ولا تُنتج تعارضاً في `css:audit`.
import './case-report-modal.css';
// محطةُ القضية (التصميم الجديد لصفحة القضية) — بدائيّاتُ `cst-*` وحدَها، بلا إعادةِ
// تعريفِ أيّ صنفٍ قائم، فلا تتعلّق بترتيب الحقن ولا تُنتج تعارضاً في `css:audit`.
import './case-station.css';
// جلساتُ العميل (صفحة «جلساتي» وبلوكاتُها في اللوحة وصفحة القضية) — بدائيّاتُ `cs-*`
// وحدَها، بلا إعادةِ تعريفِ أيّ صنفٍ قائم، فلا تتعلّق بترتيب الحقن.
...
// المشاريعُ القانونية — قائمة المشاريع في «المهام والمشاريع» وغرفة المشروع وصفحات العميل: بدائيّات `prj-*`
