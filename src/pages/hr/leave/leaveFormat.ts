...
const BLOCKER_HINTS: Record<string, string> = {
  ...
  half_day_on_range: 'سجل نصف اليوم الأول والأيام الكاملة ونصف اليوم الأخير في ثلاثة سجلات منفصلة.',
  ...
  after_termination: 'إن كانت الإجازة قبل إنهاء الخدمة فاضبط المدى عليها، وإلا فلا تسجلها على عقد منتهي.',
  sick_window_edge: 'اضبط النهاية على آخر يوم في النافذة الحالية، ثم سجل الباقي في سجل آخر.',
  ...
  negative_balance_unacknowledged: 'أكد الرصيد السالب إن كان سجلك يبين أن الموظف أخذ أكثر من استحقاقه، وإلا فراجع الرصيد الافتتاحي.',
};
...
const WARNING_HINTS: Record<string, string> = {
  ...
  missing_event_date: 'أدخل تاريخ الواقعة حتى تطبق أحكام النظام السارية في ذلك التاريخ.',
