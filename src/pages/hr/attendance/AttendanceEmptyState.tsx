  ...
  <div className="hra-scroll">
    <section className="hra-setup" aria-labelledby="hra-setup-t">
      ...
      <p className="hra-setup__lead">
        لم يحتسب يوم واحد بعد في هذا المكتب. النظام <strong>يعرض ما سجل والقرار لك</strong>: يسجل
        ما وقع، ويقترح تفسيرا، <strong>ولا يمس راتبا ولا يوقع جزاء</strong>.
      ...
      <ol className="hra-steps">
        <li className="hra-step">
          ...
          <p className="hra-step__note">
            هذه الأيام نفسها تستعمل في احتساب مدد الإجازات. أي فرق هنا يعني رقمين مختلفين في
            الوحدتين لمدة واحدة.
          </p>
        </li>
