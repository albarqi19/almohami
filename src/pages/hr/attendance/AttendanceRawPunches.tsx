 ...
 */
const RAW_TEXT = {
  title: 'بصمات لم تحتسب بعد',
  countLabel: 'عدد البصمات غير المحتسبة',
  lead: 'بصمات مسجلة كما وردت، ولم تحتسب ضمن يوم بعد.',
  engineBefore: 'تحتسب في التشغيل الليلي',
  engineTz: 'بتوقيت الرياض',
  engineNext: 'التشغيل القادم',
  tag: 'لم تحتسب بعد',
  anon: 'موظف',
  truncated: 'القائمة أطول مما تعرضه الشاشة، وتكتمل بعد التشغيل الليلي.',
} as const;
