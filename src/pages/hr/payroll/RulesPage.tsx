    ...
    <div className="hrl-page">
      <header className="hrl-head">
        <div className="hrl-head__id">
          ...
          <p className="hrl-sub">
            كل احتساب يطبق القاعدة السارية بتاريخ الواقعة، وتعديل مادة لا يغير قسيمة صرفت.
          </p>
        </div>
              ...
              <>
                <div className="hrl-block__b">
                  <p className="hrl-hint">
                    قواعد معدة وموثقة لا يطبقها النظام بعد. تطبق عند تفعيل خطوتها.
                  </p>
                </div>
                <div className="hrl-block__b hrl-block__b--flush">
        ...
        <aside className="hrl-cols__side">
          ...
          <section className="hrl-block" aria-labelledby="legend-h">
            ...
            <div className="hrl-block__b">
              ...
              <p className="hrl-hint">
                القواعد غير قابلة للتعديل من هذه الشاشة ولا من غيرها. وأي تعديل في نظام العمل
                يصل بتحديث من المنصة، ولا يغير الحسابات السابقة.
              </p>
            </div>
          </section>
        </aside>
