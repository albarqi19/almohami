...
const STATS = [
  ...
  { value: 6, suffix: '', label: 'تكاملات خارجية' },
];

const MARQUEE_ITEMS = [
  'ملف القضية كاملاً: الأطراف والوكالات والجلسات والمستندات',
  'تذكير الجلسات عبر واتساب تلقائياً',
  '٢٣ نوعاً من المذكرات القانونية',
  'باحث الأنظمة السعودية — ابحث بالمعنى لا بالكلمات',
  '٦ خدمات استعلام من منصة واثق',
...
const INTEGRATIONS = [
  {
    name: 'منصة واثق',
    icon: FileSearch,
    desc: 'ست خدمات استعلام حكومية من داخل النظام: سجل تجاري، عقود شركات، وكالات عدلية، صكوك عقارية، عنوان وطني، وبيانات موظف.',
  },
  {
    name: 'واتساب للأعمال',
    icon: MessageCircle,
...
const COMPARE_NEW = [
  'ملف قضية موحّد: الأطراف والوكالات والجلسات والمستندات في مكان واحد',
...
const FAQS = [
  ...
  {
    q: 'هل يتابع موكّلي قضيته بنفسه؟',
    a: 'نعم — بوابة عملاء بنطاق مكتبك يدخلها الموكّل فيرى قضاياه وجلساته ومستنداته وفواتيره، ويصله كل تطوّر عبر واتساب تلقائياً دون أن يتصل بالمكتب.',
  },
  {
  ...
  },
  {
    ...
    a: 'أيام معدودة: تسجيل المكتب، إدخال القضايا الجارية، ودعوة الفريق — مع تدريبٍ ودعمٍ مستمر حتى تستقر شؤون المكتب على النظام.',
  },
];
...
/* أيقونات العلامات التجارية (غير متوفرة في lucide) */
            ...
            <div className="rl-hero__grid">
              <motion.div initial="hidden" animate="show" variants={stagger}>
                ...
                <motion.p className="rl-hero__subtitle" variants={fadeUp}>
                  من فتح ملف القضية حتى تحصيل آخر فاتورة: جلسات بالهجري
            ...
            >
              ...
              <motion.div className="rl-cell rl-cell--7" variants={fadeUp}>
                ...
                <p>
                  ...
                  والميلادي — مع طلبات التنفيذ ومهلها النظامية وتنبيهٍ لكل تحديث.
                </p>
              ...
              <motion.div className="rl-cell rl-cell--7" variants={fadeUp}>
                ...
                <p>
                  تصفّح أكثر من ٦٠٠ نظام ولائحة سعودية وما يزيد على ٢٢ ألف مادة، وابحث بالمعنى لا بالكلمات — مع
        ...
        <section className="rl-cta">
          <div className="rl-container">
            <Reveal className="rl-cta__card">
              ...
              <p>
                ابدأ تجربتك المجانية اليوم — أنشئ قضاياك، وادعُ فريقك، وانطلق خلال أيام
        ...
        <div className="rl-container">
          <div className="rl-footer__grid">
            ...
            <div className="rl-footer__col">
              <h4>تواصل معنا</h4>
              <a
                className="rl-footer__social"
                href="https://wa.me/966579424294"
                target="_blank"
              ...
              <a
                className="rl-footer__social"
                href="https://x.com/alraedlaw_app"
                target="_blank"
                rel="noopener noreferrer"
              >
                <XIcon />
