...
function caseTypeLabel(t: string | null): string {
  if (!t) return '-';
  return ({ civil: 'مدنية', criminal: 'جنائية', commercial: 'تجارية', family: 'أسرية', labor: 'عمالية', administrative: 'إدارية', real_estate: 'عقارية', intellectual_property: 'ملكية فكرية', public_prosecution: 'نيابة عامة', police: 'شرطة', other: 'أخرى' } as Record<string, string>)[t] || t;
}
